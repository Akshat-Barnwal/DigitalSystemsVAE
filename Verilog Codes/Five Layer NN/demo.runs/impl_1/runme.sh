...
HD_PWD='D:/Courses/ES204_DigitalSystems/Project/finalproject/raw/demo/demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NN.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NN.tcl -notrace
