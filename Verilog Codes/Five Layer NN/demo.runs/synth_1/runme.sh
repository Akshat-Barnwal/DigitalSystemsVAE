...
HD_PWD='D:/Courses/ES204_DigitalSystems/Project/finalproject/raw/demo/demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NN.tcl
